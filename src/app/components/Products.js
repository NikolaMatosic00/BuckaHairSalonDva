...
export default function Products() {
  return (
    <>
      ...
      <h2 className="text-5xl sm:text-7xl md:text-8xl font-bold text-salon-purple mb-16 great-vibes text-center">
        Proizvodi
      </h2>
      
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          {/* Leva strana - Slike u zig-zag formaciji */}
          <div className="flex-1 relative h-[700px] lg:h-[750px]">
            {/* Prva slika - gore levo - Helen Seward (horizontalna) */}
            <div className="absolute top-[10px] left-[10px] lg:top-[20px] lg:left-[20px] w-[300px] h-[180px] lg:w-[350px] lg:h-[210px]">
              <Image
            ...
            {/* Druga slika - sredina desno - AlterEgo (horizontalna) */}
            <div className="absolute top-[220px] right-[10px] lg:top-[260px] lg:right-[20px] w-[300px] h-[180px] lg:w-[350px] lg:h-[210px]">
              <Image
            ...
            {/* Treća slika - dole levo - KYO (horizontalna) */}
            <div className="absolute bottom-[10px] left-[50px] lg:bottom-[20px] lg:left-[70px] w-[300px] h-[180px] lg:w-[350px] lg:h-[210px]">
              <Image
          ...
          {/* Desna strana - Tekst o proizvodima */}
          <div className="flex-1 lg:pl-8">
            <div className="space-y-8">
              ...
              <div className="bg-salon-white p-4 shadow-md">
                <h4 className="text-lg font-semibold text-salon-purple mb-2">

...
export default function Team() {
  return (
    <section id="team" className="py-12 sm:py-16 px-2 sm:px-4 md:px-16 text-center bg-gradient-to-b from-[#F7F2FF] to-white animate-on-scroll relative">
      ...
      <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 w-full h-8 md:h-12 bg-salon-purple z-0 rounded" />
        ...
        <div className="flex flex-row gap-4 justify-center relative animate-on-scroll max-w-7xl mx-auto" style={{minHeight: '260px'}}>
          <div className="relative flex flex-col items-center flex-1 mt-0 mb-32 z-10 group">
            <div className="transition-transform duration-300 group-hover:scale-105 group-hover:shadow-lg flex flex-col items-center">
              <Image
                ...
                width={250}
                height={350}
                className="rounded-lg mb-4 object-cover w-full h-[140px] md:w-[250px] md:h-[350px] transition-transform duration-300 group-hover:scale-105 group-hover:shadow-lg"
              />
              ...
              <p className="text-xl md:text-2xl text-salon-black great-vibes font-bold mb-2 transition-all duration-300 group-hover:text-salon-purple/80 group-hover:scale-102">Osnivačica salona</p>
            </div>
          </div>
          <div className="relative flex flex-col items-center flex-1 mt-16 mb-16 z-10 group">
            <div className="transition-transform duration-300 group-hover:scale-105 group-hover:shadow-lg flex flex-col items-center">
              ...
              <p className="text-xl md:text-2xl text-salon-black great-vibes font-bold mb-2 transition-all duration-300 group-hover:text-salon-purple/80 group-hover:scale-102">Frizerski specijalista</p>
            </div>
          </div>

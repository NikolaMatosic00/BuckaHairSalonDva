...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="py-12 sm:py-16 px-4 sm:px-6 md:px-16 pt-20 md:pt-4 text-center bg-gradient-to-b from-[#f9fafc] to-[#F7F2FF]"
    >
...
<div className="mt-8 animate-on-scroll" data-animate-delay="600">
          <a
            href="/#contact"
            className="group inline-flex items-center justify-center bg-salon-black text-white px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium text-sm sm:text-base transition-all"
          >

import { FaPhone, FaInstagram, FaFacebook, FaWhatsapp, FaViber } from 'react-icons/fa';
        ...
        <div className="flex flex-col gap-8 sm:gap-12 relative">
          ...
          >
            ...
            <a
              ...
              className="text-xl sm:text-2xl text-salon-black font-medium hover:text-salon-dark-purple hover:scale-105 transition-all duration-300"
            >
              +381 69 116 8623
            </a>
          </motion.div>
          ...
          >
            <a
              ...
              className="text-salon-black hover:text-[#E1306C] transition-colors duration-300"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-salon-black hover:text-[#1877F2] transition-colors duration-300"
              aria-label="Facebook"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-salon-black hover:text-[#25D366] transition-colors duration-300"
              aria-label="WhatsApp"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-salon-black hover:text-[#7360F2] transition-colors duration-300"
              aria-label="Viber"
            >
